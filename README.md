...
* You need access to a couple local [Postgres] databases.  One named
  `my_first_web` and the other `my_first_web_tests`.  The latter is
...
### First-time Setup
    ...
    $ raco pkg install my-first-web/        # install and build the application and its deps
    $ raco pkg install my-first-web-tests/  # install and build the tests and their deps
